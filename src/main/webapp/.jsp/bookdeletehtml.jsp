...
<div align="CENTER" class="form-outline mb-4">
    <img src="book3.jpg" height="300" width="600">
    </br>
    </br>
    </br>
    </br>

<h2 style="color: coral" align="CENTER"><strong>PLEASE ENTER ISBN CODE</strong></h2>
</br>

<form action="bookdelete.jsp">
    <div align="CENTER"class="form-outline mb-4">
        <%--@declare id="inputbook"--%><label style="color:cadetblue" for="inputBook"><strong>ISBN CODE</strong></label>
