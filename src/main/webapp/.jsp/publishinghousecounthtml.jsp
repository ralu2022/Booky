...
<div align="CENTER">
  <img src="book15.jpg" height="300" width="600">
  <br>
  <br>
  <br>
  <h2 style="color: coral"><strong>PUBLISHING HOUSE COUNT BY CITY</strong></h2>
  <br>
  <br>
  <table align="CENTER" border="1" class="table table-striped table-hover w-50 p-3">
    ...
    <%
      ...
      List<PublishingHouse> publishingHouses = repository.getAllPublishingHousesByCity();
      for (PublishingHouse publishingHouse : publishingHouses) {
    %>
    <tr>
      <td><%= publishingHouse.getCity()%>
      </td>
      <td><%= publishingHouse.getCity_count()%>
      </td>
    </tr>
    <% } %>
  </table>
