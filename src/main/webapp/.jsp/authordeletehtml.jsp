...
<div align="CENTER" class="form-outline mb-4">
    ...
    <h2 style="color: coral" align="CENTER"><strong>PLEASE ENTER AUTHOR NAME</strong></h2>
    </br>
    </br>
    </br>
    <form action="authordelete.jsp">
        <div align="CENTER" class="form-outline mb-4">
            <%--@declare id="inputbook"--%><label style="color:cadetblue" for="inputBook"><strong>AUTHOR
            NAME</strong></label>
